...
const NftmarkBox: Component<Props> = (props) => {
  ...
  return (
    <div style={{ 'background-image': 'url(/assets/temp-box.png)', width: props.width }} class=" overflow-hidden relative responsive-square border-2 border-red self-start rounded-md
